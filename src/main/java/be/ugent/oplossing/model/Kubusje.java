...
//    Kubusje kub = new Kubusje(centrum, Color.RED,Color.GREEN,Color.YELLOW,Color.BLACK,Color.BLACK,Color.BLUE);
    ...
    public Kubusje(Hoekpunt centrum, Color boven, Color voor, Color links, Color achter, Color rechts, Color onder)
    {
        ...
        // bovenvlak
        Hoekpunt bovenRechtsachter = centrum.add(new Hoekpunt(-1,1,1));
        Hoekpunt bovenRechtsvoor = centrum.add(new Hoekpunt(1,1,1));
        Hoekpunt bovenLinksvoor = centrum.add(new Hoekpunt(1,-1,1));
        Hoekpunt bovenLinksachter = centrum.add(new Hoekpunt(-1,-1,1));

        Hoekpunt onderRechtsachter = centrum.add(new Hoekpunt(-1,1,-1));
        Hoekpunt onderRechtsvoor = centrum.add(new Hoekpunt(1,1,-1));
        Hoekpunt onderLinksvoor = centrum.add(new Hoekpunt(1,-1,-1));
        Hoekpunt onderLinksachter = centrum.add(new Hoekpunt(-1,-1,-1));
        ...
        vlakken.add(new Vlak(voor, new Hoekpunt[]{bovenRechtsvoor,onderRechtsvoor,onderLinksvoor,bovenLinksvoor}));
        vlakken.add(new Vlak(links, new Hoekpunt[]{bovenLinksachter,onderLinksachter,onderLinksvoor,bovenLinksvoor}));
    }

    public List<Vlak> getAllVlakken() {
        return vlakken;
    }
}
